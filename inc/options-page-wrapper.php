...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
		<a href="?page=venobox&tab=markup_options" class="nav-tab <?php echo $active_tab == 'markup_options' ? 'nav-tab-active' : ''; ?>"><?php esc_attr_e('Markup Instructions', 'venobox'); ?></a>
		<a href="?page=venobox&tab=plugin_options" class="nav-tab <?php echo $active_tab == 'plugin_options' ? 'nav-tab-active' : ''; ?>"><?php esc_attr_e('Plugin Options', 'venobox'); ?></a>
	</h2>
			...
			<div id="post-body-content">
				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div class="postbox">
						...
						<div class="inside">
              <p><?php esc_attr_e( 'Below are manual instructions for using the VenoBox Lightbox for your code.', 'venobox' ); ?><br>
								 <?php esc_attr_e( 'In the', 'venobox' ); ?> <strong>Plugin Options</strong><?php esc_attr_e( ' tab some of these tasks can be automated, in particular for images.', 'venobox' ); ?></p>

							<p><?php esc_attr_e( 'Typically for the lightbox to work  you wrap a link around a text or image element.', 'venobox' ); ?></p>
              <pre style="white-space:pre-wrap;">&lt;a class="venobox" data-type="vimeo" href="https://vimeo.com/1084537"&gt;&lt;img src="..." /&gt;&lt;/a&gt;
              </pre>
							<h4><?php esc_attr_e( 'Video - Vimeo Example', 'venobox' ); ?></h4>
              <a class="venobox" data-type="vimeo" href="https://vimeo.com/1084537">
              <?php
                echo '<img src="' . plugins_url( 'images/bunny.jpg', dirname(__FILE__) ) . '" > ';
                ?>
              </a>
              <p><?php esc_attr_e( 'When clicked the lightbox will execute showing the linked content.', 'venobox' ); ?></p>

              <p><?php esc_attr_e( 'To use', 'venobox' ); ?> <strong>Venobox</strong><?php esc_attr_e( ' you need to ensure the CSS class', 'venobox' ); ?><code>class="venobox"</code><?php esc_attr_e( 'is used in the link mark up and also if the lightbox content is not an image the', 'venobox' ); ?><code>data-type</code> <?php esc_attr_e( 'attribute is also required', 'venobox' ); ?><code>data-type="vimeo"</code><?php esc_attr_e( 'or other Data Type, see below under Data Types', 'venobox' ); ?>.</p>
                <h4><?php esc_attr_e( 'Data Types', 'venobox' ); ?></h4>
              <p><?php esc_attr_e( 'If the content is not an image you have to specify its type via data attribute', 'venobox' ); ?> <code>data-type</code></p>
              <p><?php esc_attr_e( 'Available data-type values', 'venobox' ); ?>: <code>youtube</code> <code>vimeo</code> <code>iframe</code> <code>inline</code> <code>ajax</code> </p>
...
&lt;a class="venobox" data-type="vimeo" href="http://vimeo.com/75976293"&gt;Vimeo&lt;/a&gt;
			...
			<h4><?php esc_attr_e( 'Image Example', 'venobox' ); ?></h4>
				...
				<?php
					...
					?>
					<p><?php esc_attr_e( 'Image example above has titles, pagination, gallery and infinite gallery', 'venobox' ); ?>.</p>

        <h4><?php esc_attr_e( 'Title Attribute', 'venobox' ); ?></h4>
              <p><?php esc_attr_e( 'Optional: set ', 'venobox' ); ?><code>title</code><?php esc_attr_e( ' attribute to show a description, it will appear at the top of the lightbox.', 'venobox' ); ?></p>
<pre data-initialized="true" data-gclp-id="5" style="white-space:pre-wrap;">
&lt;a class="venobox" title="Here is your description" href="...
</pre>
        <h4><?php esc_attr_e( 'Auto Play', 'venobox' ); ?></h4>

              <p><?php esc_attr_e( 'Use ', 'venobox' ); ?><code>data-autoplay="true"</code><?php esc_attr_e( ' to automatically start Vimeo and YouTube videos once the text or image link is clicked', 'venobox' ); ?></p>
...
&lt;a class="venobox" data-autoplay="true" data-type="youtube" href="...
        ...
        <h4><?php esc_attr_e( 'Overlay colors', 'venobox' ); ?></h4>
        <p><strong><?php esc_attr_e( 'Examples', 'venobox' ); ?>:</strong><br>
        ...
        <p>
        <?php esc_attr_e( 'Just add a ', 'venobox' ); ?><code>data-overlay</code><?php esc_attr_e( 'attribute value to your links for colored backgrounds', 'venobox' ); ?></p>
...
&lt;a class="venobox" data-overlay="#ca294b" href="..."&gt;...&lt;/a&gt;
      ...
      <h4><?php esc_attr_e( 'Gallery', 'venobox' ); ?></h4>

        <p><?php esc_attr_e( 'To activate navigation previous and next icons whilst in lighbox mode between multiple types of content on the same page, assign the same data attribute ', 'venobox' ); ?><code>data-gall</code><?php esc_attr_e( ' to each link, like the example below, you can see this in the colors example above.', 'venobox' ); ?></p>
...
&lt;a class="venobox" data-gall="myGallery" href="image03-big.jpg"&gt;&lt;img src="image03-small.jpg" /&gt;&lt;/a&gt;
        ...
        <div id="inline-1" style="display:none;">
            ...
            <h1>Custom</h1>
            <p><?php esc_attr_e( 'set different custom overlay colors for each link', 'venobox' ); ?></p>
            </div>
        </div>
				...
				<div class="meta-box-sortables">
					...
					<div class="postbox">
						...
						<div class="inside">
							<p>
								<?php esc_attr_e(
											'VenoBox is the work of ', 'venobox'
										); ?> @NicolaFranchini<br>
